...
# bash run/test.sh timm.vit_base_patch16_224_in21k lora.yaml VTAB-1k.CIFAR-100 /data/zhangyk/data/petl /data/zhangyk/data/petl/model/ViT-B_16.npz /data/zhangyk/models/kel_logs/lora_cifar/best.pt